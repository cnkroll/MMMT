...
# Figure 3b: Annual Duration Curves (DCs) from depth to groundwater records
# Last Updated: August 2025

# This example produces Figure 3b from the recently submitted article: 
...
# Archer, NE :USGS#410618098113401. The pre-disturbance record was chosen as the 1986-2005 and
...
###
  ...
  # Enter the site number for Archer, NE
  # [For different USGS sites, the site number will change]

  SiteNumber <- c("410618098113401")
