...
# This example produces Figure 2b from the recently submitted article: 
...
# NOAA’s National Centers for Environmental Information for Central Park in New York City, NY (USW00094728) are obtained for the period 1901 to 2023. 
...
# read into R. See "Precipitation_CentralPark.csv" for file structure and column headings.
...
###
  ...
  # Read in the .csv file containing the precipitation (in) data for the study site Central Park in New York City, NY (USW00094728)

  data <- read.csv(file = "Precipitation_CentralPark.csv", header = T, sep = ",")   
...
###
  ...
  pdfname <-paste0("Figure_2b.pdf") 
  
  # Set labels for plot
  
  label<-as.character(array(0,5))
  label[1]<- "Precipitation in Central Park, NY"
